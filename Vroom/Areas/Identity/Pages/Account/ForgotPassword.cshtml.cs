...
namespace Vroom.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(IApplicationUserManager<ApplicationUser> userManager, IEncodingProvider encodingProvider, IWebEncodersProvider webEncodersProvider)
        {
