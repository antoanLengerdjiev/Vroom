...
namespace Vroom.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(IApplicationUserManager<ApplicationUser> userManager, IEncodingProvider encodingProvider, IWebEncodersProvider webEncodersProvider)
        {
