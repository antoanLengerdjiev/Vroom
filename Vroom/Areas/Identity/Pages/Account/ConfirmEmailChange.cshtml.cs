...
namespace Vroom.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmEmailChangeModel : PageModel
    {
        ...
        public ConfirmEmailChangeModel(IApplicationUserManager<ApplicationUser> userManager, IApplicationSignInManager<ApplicationUser> signInManager, IEncodingProvider encodingProvider, IWebEncodersProvider webEncodersProvider)
        {
